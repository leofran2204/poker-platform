...
> **Antes de criar nova pasta, codar nova feature ou tomar decisão arquitetural, sempre consultar este documento, `QUALITY.md` (documento mestre) e a pasta `05-Documentacao/` (BUSINESS_RULES.md, STATUS.md).**
