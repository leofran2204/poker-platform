...
> **Marco S22 (2026-09-07):** gameplay MTT ao vivo (3 mesas, ator, payouts, 1º campeão) + fee 15% com split 18/12 + bots em MTT + run-out anti-travamento.

**Atualizado:** 2026-09-07 | **Status:** Roadmap; ciclo **S22** — MTT jogável + fee + bots; demo VPS **zerotiltpoker.net**.
...
2026-09-04 ██  S21 — Texas rename (035) + FT 8 (036) + Omaha 5/Pineapple 6 (037) + scheduled 21:30 + seats (038) + SD 8-max (039) + 040 fixo + ranking trips>straight + Pix Leofran + saque 24h + sim 100k/mesa + VPS 2h 980 mãos R$135
2026-09-04 ██  S21b — PM 150+150 sem rebuy (041/044) + cash→150 (042) + restore MTT (043) + Dockerfile cache build ~20s + validado fim a fim
2026-09-07 ██  S22 — 3 mesas/torneio + caps (048) + fee 15% + total_fees (049) + ator MTT + run-out + halt auditável + bots MTT + 1º campeão ao vivo
2026-09-10 ██  S23 — Bots externos de estratégia: bot/strategy (ranges cash/MTT, avaliador, ICM) + strategy-bots.mjs validado ao vivo (3 bots, 5 mãos, hand_history)
2026-09-10 ██  S23 — Migration 053: cash NL 0,75/1,50 PM+Real + torneios Texas R$25 PM+Real (buy-in 2500/15k + 1 reentrada 25k)
2026-09-10 ██  S23 — Ritual do crupiê no frontend (banner + distribuição por assento)
2026-09-10 ██  S23 — Bots VPS desligados (stop + reembolso) + showdown fixo e board lento
```
