...
*   **TypeScript/React (`Frontend-Web`):** UI canônica no navegador (Vite + Tailwind).
    Dioxus/WASM foi removido do monorepo (2026-08-28).
...
> **🗑️ Removido do monorepo (2026-08-28).** O frontend canônico é `Frontend-Web/` (`npm run lint` = tsc + ESLint; `npm test` = Vitest 16; `npm run build`).
