...
>
> **Atualização 2026-09-10 (S24):** `Frontend-Web` tem Vitest 16 (`money`, `gameLabels`, `safeHttpUrl`, ticket WS 401/403) + ESLint (`react-hooks`, `jsx-a11y`). `npm test` / `npm run lint`. Não substitui as metas históricas da Fase 2 abaixo.
