...
> **Marco S24 (2026-09-10):** frontend de vitrine + lobby 053 + mesa jogável (herói embaixo, Disconnect ≠ Leave) + Vitest/ESLint. MTT ao vivo (S22) permanece.

**Atualizado:** 2026-09-10 | **Status:** Roadmap; ciclo **S24** — UI alinhada ao catálogo e à mesa; demo VPS **zerotiltpoker.net**.
...
> 📌 Fonte canônica de estado: [`STATUS_OPERACIONAL.md`](STATUS_OPERACIONAL.md) (prevalece sobre percentuais deste arquivo).
...
FASE 3 ████████████████████████████ 100%  Front-end canônico TypeScript Full Tilt (`Frontend-Web`; S11→S24). Dioxus = histórico.
...
2026-09-10 ██  S23 — Diário de mãos + replay com download (sem auto-fechar)
```
