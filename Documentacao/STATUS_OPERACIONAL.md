...
# Estado operacional — S25

**S25** — quatro modalidades + showdown completo + Loss Deflator com side pots. Revisado em **2026-09-26**. Ambiente: **demo/staging** em [zerotiltpoker.net](https://zerotiltpoker.net) (VPS Hostinger).
...
Frentes fixas (`min_buy_in = max_buy_in`). Migrations até **059**.
