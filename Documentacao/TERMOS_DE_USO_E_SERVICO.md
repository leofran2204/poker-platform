...
6.3. **Movimentação automática via DePix:** depósitos são creditados somente após a confirmação final do provedor (`completed`); estados intermediários não liberam saldo. O crédito corresponde ao **valor líquido recebido do provedor, deduzidas as taxas dele** (visível no extrato da carteira). Saques automáticos vão exclusivamente para chave PIX de titularidade do próprio Jogador (CPF/CNPJ validado) até o teto publicado; acima dele, o saque aguarda revisão manual em até 24h. Falhas do provedor recreditam o saldo reservado, sem estorno PIX.
