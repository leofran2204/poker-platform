...
> **Estado (ver `STATUS_OPERACIONAL.json`):** **S22** — gameplay MTT ao vivo em 3 mesas + fee 15% com split 18/12 + bots em MTT; catálogo cash NLHE 9-max + SD 8-max + SD Omaha 5-max + Pineapple 6-max (PM×Real); frentes fixas; wallets isoladas; depósitos manuais; sem certificação de produção.
