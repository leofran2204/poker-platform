...
**Dono** da carga massiva. O gate do dia a dia (CI, clippy, testes determinísticos) é [`QUALITY.md`](QUALITY.md). Metas Fase 2 antigas: [`historico/TESTING_GOALS.md`](historico/TESTING_GOALS.md). Scripts: [`../scripts/README.md`](../scripts/README.md).
