...
*Números e limites vigentes: [`STATUS_OPERACIONAL.md`](STATUS_OPERACIONAL.md). Este texto de posicionamento é de 2026-09-04. Não alegar certificação de produção, PIX de produção nem autoexclusão pronta.*
