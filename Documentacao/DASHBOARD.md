...
**Atualizado:** 2026-09-04 | **Status:** **S21** — Texas Hold’em rename + FT Short Deck 8-max + Omaha 5-max + Pineapple 6-max + ranking trips>straight + torneio agendado 21:30 SP auto-start 5 + Pix Leofran + saque 24h + sim 100k/mesa; demo/staging; sem certificação de produção.
...
| S21 | 2026-09-04 | Texas rename + FT 8 + Omaha 5 + ranking + agendado + Pix + sim 100k | Texas Hold’em (035); FT Short Deck 8-max (036); Omaha 5-max + Pineapple 6-max (037); scheduled 21:30 SP auto 5 + tournament_seats (038); SD cash 8-max (039); scheduled 21:30 fixo (040); ranking trips>straight (deck.rs); Pix Leofran + saque 24h; lobby max sempre; full-catalog-100 + simulated_100 100k/mesa | 🟢 Fechado (demo); VPS 2h 980 mãos R$135 |
