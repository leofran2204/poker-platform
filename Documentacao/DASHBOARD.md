...
| LD56| **Loss Deflator por Equity, após o Rake** — Regra vigente: <56%=0%; 56–65,9%=7%; 66–75,9%=15%; 76–85,9%=25%; ≥86%=35%. A fase apenas reconstrói o board no instante do all-in; não determina o tier. Main pot e side pots são taxados antes do cashback. Cenários de limites, 7% real e múltiplos snapshots validados. | 2026-07-30 |
