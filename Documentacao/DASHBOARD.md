...
**Atualizado:** 2026-09-07 | **Status:** **S22** — gameplay MTT ao vivo (3 mesas, ator, eliminações, payouts, 1º campeão) + fee 15% por cima com split 18/12 + bots lag_v2 em MTT + run-out anti-travamento; demo/staging; sem certificação de produção.
