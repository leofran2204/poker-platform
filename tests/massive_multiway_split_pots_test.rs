...
fn test_5_way_all_in_cascading_side_pots() {
    ...
    let contributions = vec![
        ...
        Contribution { player_id: "P2".into(), total_bet: 200.0, has_folded: false },
        Contribution { player_id: "P3".into(), total_bet: 300.0, has_folded: false },
        Contribution { player_id: "P4".into(), total_bet: 400.0, has_folded: false },
        Contribution { player_id: "P5".into(), total_bet: 500.0, has_folded: false },
    ];
...
fn test_multiway_split_pot_tiebreaker_by_kicker() {
    ...
    assert!(rank_p1 > rank_p2, "P1 deve vencer P2 devido ao Kicker Ás vs Dama");
}
...
fn test_exact_tie_identical_straight_split_pot() {
    ...
    assert_eq!(rank_p1, rank_p2, "Straight idêntica deve ser um empate absoluto (Split Pot)");
}
...
fn test_folded_highest_stack_player_side_pot_isolation() {
    ...
    let contributions = vec![
        Contribution { player_id: "P1".into(), total_bet: 100.0, has_folded: false },
        Contribution { player_id: "P2".into(), total_bet: 1000.0, has_folded: true }, // FOLDED!
        Contribution { player_id: "P3".into(), total_bet: 1000.0, has_folded: false },
    ];
...
fn test_zero_sum_pot_conservation_complex_all_in() {
    let contributions = vec![
        Contribution { player_id: "P1".into(), total_bet: 150.0, has_folded: false },
        Contribution { player_id: "P2".into(), total_bet: 300.0, has_folded: true },
        Contribution { player_id: "P3".into(), total_bet: 450.0, has_folded: false },
        Contribution { player_id: "P4".into(), total_bet: 600.0, has_folded: false },
    ];
    ...
    assert_eq!(total_pots, 1500.0, "A soma dos potes DEVE ser exatamente igual à soma das apostas (Conservação de Saldo)");
}
