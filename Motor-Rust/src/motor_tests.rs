...
mod csprng_tests {
    ...
    fn u32_distribuicao_sem_vies_d2() {
        ...
        assert!((48.0..=52.0).contains(&pct0), "Face 0: {:.2}% — viés", pct0);
        assert!((48.0..=52.0).contains(&pct1), "Face 1: {:.2}% — viés", pct1);
    }
    ...
    fn u64_dentro_do_range_sempre() {
        for _ in 0..5_000 {
            ...
            assert!((1_000..=9_999).contains(&val));
        }
    }
